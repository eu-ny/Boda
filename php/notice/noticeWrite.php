            ...
            <section class="mid__container">
                <form action="noticeWriteSave.php" name="noticeWrite" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="mid__icon">
                            <div class="link">
                                <input type="file" name="noticeFile" id="noticeFile" accept=".jpg, .jpeg, .png, .gif" placeholder="jpg(jpeg), png, gif 파일만 첨부 가능합니다.">
                            ...
                            <div class="board__table">
                                <div>
                                    <div>
                                        ...
                                        <input type="text" name="noticeTitle" id="noticeTitle" class="Title" placeholder="제목을 입력해 주세요." required>
                                    </div>
                                    <div style="margin-top: 20px;">
                                        <label class="blind" for="noticeSubTitle">부제목</label>
                                        <input type="text" name="noticeSubTitle" id="noticeSubTitle" class="Title" placeholder="부제목을 입력해 주세요." required>
                                    </div>
                                    <div>
